...
if __name__ == '__main__':
    ...
    #cap = cv2.VideoCapture(dir_name+subject+"/"+condition+"/"+scenario+extension)
    cap = cv2.VideoCapture("D:/Dataset/NTHU-DDD/Training_Evaluation_Dataset/Training_Dataset/001/noglasses/sleepyCombination.avi")
    while cap.isOpened():
        ret, frame = cap.read()
        if ret:
