...
if __name__ == '__main__':
    ...
    while cap.isOpened():
        ...
        if ret:
            ...
            height, width, channel = INPUT_SIZE[0], INPUT_SIZE[1], 3
            ...
            for b in dets:
                ...
                landmark5[0] = [b[5], b[6]]
                landmark5[1] = [b[7], b[8]]
                landmark5[2] = [b[9], b[10]]
                landmark5[3] = [b[11], b[12]]
                landmark5[4] = [b[13], b[14]]

                tform = trans.SimilarityTransform()
                tform.estimate(landmark5, warp_arr)
                M = tform.params[0:2, :]
                face_align = cv2.warpAffine(img_raw, M, (INPUT_SIZE[0], INPUT_SIZE[1]), borderValue=0.0)
