                ...
                if ret:
                    ...
                    for b in dets:
                        ...
                        if args.save_image:
                            ...
                            if not os.path.exists(save_dir + subject + "/" + subject + scenario + "/" + "righteye/"):
                                os.makedirs(save_dir + subject + "/" + subject + scenario + "/" + "righteye/")
                            right_eye_path = save_dir + subject + "/" + subject + scenario + "/" + "righteye/" + str(
                                frame_num) + ".jpg"
