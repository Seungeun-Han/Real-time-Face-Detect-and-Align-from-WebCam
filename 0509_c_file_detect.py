...
if __name__ == '__main__':
    ...
    resize = 1
    dir_name = "D:/Dataset/NTHU-DDD/Training_Evaluation_Dataset/Training Dataset/"
    ...
    ['nonsleepyCombination', 'sleepyCombination', 'slowBlinkWithNodding', 'yawning']"""
                ...
                while cap.isOpened():
                    ...
                    if ret:
                        ...
                        for b in dets:
                            ...
                            fixed_face = cv2.warpAffine(contrast_norm_img, rect_matrix,
                        ...
                        # save image
                        if args.save_image:
                            save_dir = "D:/Dataset/NTHU-DDD-contrast/Training_Evaluation_Dataset/Training Dataset/"
                            part_list = ['left_eye', 'mouth', 'right_eye']


                            if not os.path.exists(save_dir + subject + "/" + condition + "/" + scenario + "/" + "left_eye/"):
                                os.makedirs(save_dir + subject + "/" + condition + "/" + scenario + "/" + "left_eye/")
                            left_eye_path = save_dir + subject + "/" + condition + "/" + scenario + "/" + "left_eye/" + str(
                                frame_num) + ".jpg"

                            if not os.path.exists(save_dir + subject + "/" + condition + "/" + scenario + "/" + "right_eye/"):
                            ...
                            if not os.path.exists(save_dir + subject + "/" + condition + "/" + scenario + "/" + "mouth/"):
