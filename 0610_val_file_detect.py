...
if __name__ == '__main__':
    ...
    resize = 1
    dir_name = "D:/Dataset/NTHU-DDD/Training_Evaluation_Dataset/Evaluation_Dataset/"
    ...
    txt_list = ['_glasses_mixing_drowsiness.txt', '_nightglasses_mixing_drowsiness.txt', '_night_noglasses_mixing_drowsiness.txt', '_noglasses_mixing_drowsiness.txt', '_sunglasses_mixing_drowsiness.txt']
    extension =".mp4"

    save_dir = "D:/Dataset/NTHU-DDD-gc/Training_Evaluation_Dataset/Evaluation_Dataset2/"

    for subject in subject_list:
        for index, scenario in enumerate(scenario_list):
            print(dir_name+subject+"/"+subject+scenario+extension)
            #cap = cv2.VideoCapture(dir_name + subject + condition + scenario + extension)
            cap = cv2.VideoCapture(dir_name+subject+"/"+subject+scenario+extension)

            txt_num = 0
            frame_num = 0
            txt = []
            # tmp = np.loadtxt(dir_name + subject + '/' + subject + txt_list[index])
            label = open(dir_name + subject + '/' + subject + txt_list[index], 'r')
            label = list(label)
            # print(label[0])
            """print(len(label[0]))
            print(txt_num)
                ...
                if ret:
                    ...
                    for b in dets:
                        ...
                        if args.save_image:
                            ...
                            if not os.path.exists(save_dir + subject + "/" + subject + scenario + "/" + "left_eye/"):
                                os.makedirs(save_dir + subject + "/" + subject + scenario + "/" + "left_eye/")
                            left_eye_path = save_dir + subject + "/" + subject + scenario + "/" + "left_eye/" + str(
                                frame_num) + ".jpg"

                            if not os.path.exists(save_dir + subject + "/" + subject + scenario + "/" + "right_eye/"):
                                os.makedirs(save_dir + subject + "/" + subject + scenario + "/" + "right_eye/")
                            right_eye_path = save_dir + subject + "/" + subject + scenario + "/" + "right_eye/" + str(
                                frame_num) + ".jpg"

                            if not os.path.exists(save_dir + subject + "/" + subject + scenario + "/" + "mouth/"):
                                os.makedirs(save_dir + subject + "/" + subject + scenario + "/" + "mouth/")
                            mouth_path = save_dir + subject + "/" + subject + scenario + "/" + "mouth/" + str(
                                frame_num) + ".jpg"

                            """if not os.path.exists(save_dir + subject + "/" + subject + scenario + "/" + "face/"):
                                os.makedirs(save_dir + subject + "/" + subject + scenario + "/" + "face/")
                            face_path = save_dir + subject + "/" + subject + scenario + "/" + "face/" + str(
                                frame_num) + ".jpg" """
