...
if __name__ == '__main__':
    ...
    extension =".avi"
    txt_list = ['_nonsleepyCombination_drowsiness.txt', '_sleepyCombination_drowsiness.txt', '_slowBlinkWithNodding_drowsiness.txt', '_yawning_drowsiness.txt']
    ...
    save_dir = "D:/Dataset/NTHU-DDD-gc/Training_Evaluation_Dataset/Training_Dataset2/"
